...
public class BoomBox : MonoBehaviour
{
    ...
    /// This one lets you * a float by globalVolume to create a smaller sound
	public static bool Play(SoundEnum.Sound b, float vol) { return GameObject.Find("BoomBox").GetComponent<BoomBox>().GCPlay(b.ToString(), vol); }
